...
public class SimpleMesh {
    ...
    private final String fragmentShaderCode =
            "#version 300 es\n" +
                    ...
                    "    FragColor = mix(white, texture(uTexture, TexCoord), uProgress);\n" +
                    "}";
    ...
    public void draw(int tex, float[] matrix, float progress) {
        GLES32.glUseProgram(program);

        GLES32.glUniform1f(GLES32.glGetUniformLocation(program, "uProgress"), progress);
        GLES32.glUniformMatrix4fv(GLES32.glGetUniformLocation(program, "uMatrix"), 1, false, matrix, 0);
